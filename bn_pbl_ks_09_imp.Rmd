...
do_przedmiotowej2 <- do_przedmiotowej2[!duplicated(do_przedmiotowej2$id_grupy),] %>%
  mutate(TW_TWORCA_ID = NA,
         TW_NAZWISKO = NA,
         TW_IMIE = NA) %>%
  select(names(do_przedmiotowej))

do_przedmiotowej <- rbind(do_przedmiotowej1,do_przedmiotowej2)

### sprawdzić, co dalej da się zrobić

### wymusić ręczne przypisanie dla następujących warunków w 655: teoria - PAULINA, film - OLA - teatr|dramat - MARTA
