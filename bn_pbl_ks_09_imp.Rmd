...
###dlaczego drugie przypisywanie rodzaju zmienia błędnie dobrą przedmiotową na złą podmiotową? vide: Rosja i Rosjanie w pamiętnikach
test <- test %>%
  slice(68)
...
count <- as.data.frame(table(bn_ok$czy_automatycznie))
...
```
Czy w ogóle jest sens to robić?
