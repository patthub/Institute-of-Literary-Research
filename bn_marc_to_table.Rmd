...
bn1 <- read.csv2("C:/Users/User/Desktop/bn_all_1.csv", encoding = "Windows-1250", header = TRUE, stringsAsFactors = FALSE) 
bn2 <- read.csv2("C:/Users/User/Desktop/bn_all_2.csv", encoding = "Windows-1250", header = TRUE, stringsAsFactors = FALSE) 
bn3 <- read.csv2("C:/Users/User/Desktop/bn_all_3.csv", encoding = "Windows-1250", header = TRUE, stringsAsFactors = FALSE) 
bn4 <- read.csv2("C:/Users/User/Desktop/bn_all_4.csv", encoding = "Windows-1250", header = TRUE, stringsAsFactors = FALSE) 

data_full <- rbind(bn1,bn2,bn3,bn4)
