...
rD <- rsDriver(port=4444L,browser="chrome", chromever="77.0.3865.10")
remDr <- rD$client
...
write.csv2(table_data, "C:/Users/Cezary/Desktop/czech_literary_prizes_1.csv", row.names = F, na = '', fileEncoding = 'Windows-1250')
