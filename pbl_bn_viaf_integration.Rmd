...
options(scipen = 999)
pacman::p_load(googlesheets,zoo,openxlsx,stringr,splitstackshape,plyr,dplyr,sqldf,stringdist,fuzzyjoin,data.table,svMisc,tidyverse,RJDBC,xlsx,rvest,RSelenium,jsonlite)
...
#pbl_tworcy <- read.csv2("C:/Users/User/Desktop/tworcy_pbl.csv", encoding = "Windows-1250", header = TRUE, stringsAsFactors = FALSE, sep = ",")
